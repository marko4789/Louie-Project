...
insert  into `tabla_alumnos`(`id_alumno`,`nombre`,`apellido_paterno`,`apellido_materno`,`edad`,`salon`,`status`) values (1,'Marco','Ocampos','Ortega',20,'3-2','Activo'),(2,'Mónica ','Lizbeth','Ruiz',20,'3-2','Activo'),(3,'Juan','Tirado','Ortega',9,'4A','Activo'),(4,'Emilio','Tirado','González',9,'4A','Activo'),(5,'Mariano ','Fuentes','Del Río',10,'4B','Activo');
...
insert  into `tabla_usuarios`(`id_usuario`,`nombre`,`contraseña`,`status`,`tipo`,`id_alumno`) values (1,'marko','contraseña','Activo','Administrador',1),(2,'moni','si','Activo','Administrador',2),(3,'juanito','no','Activo','Alumno',3);
...
insert  into `tabla_puntajes`(`id_puntajes`,`memorama`,`id_usuario`) values (1,215,1),(2,0,2);
...
insert  into `puntaje_trivia`(`id_puntaje_trivia`,`puntaje`,`id_materia`,`id_puntajes`) values (1,10,1,1),(2,8,2,1),(3,6,3,1),(4,0,1,2),(5,0,2,2),(6,0,3,2),(7,0,4,2);
